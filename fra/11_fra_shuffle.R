# calculate shuffeled NTR scores for France
...
# read LDA output
fra_lda = read_csv("fra/data/fra_ntr_in.csv")

# set seed for reproducibility
set.seed(42)

# shuffle rows
random_rows <- sample(nrow(fra_lda))
shuffled_speeches <- fra_lda[random_rows, ]

write_csv(shuffled_speeches, "fra/data/shuffled_speeches.csv")
...
calculate_ntr <- function(w) {
  ...
  import = read_csv("fra/data/shuffled_speeches.csv")
